      ...
      <Card className='p-0 rounded-none border-0'>
              ...
              <div className="md:flex hidden items-center  gap-3 ">
                ...
                <Link href="/auth/login" className="">
                  ...
                  >
                    ...
                    <MoveLeft className='ltr:rotate-180' />
                  </Button>
                </Link>
              </div>
            </div>
        ...
        <Card
          className={`${isOpen ? 'max-h-screen ' : 'max-h-0 '
            } h-full overflow-hidden p-0 border-0 rounded-none md:hidden fixed top-16 right-0 bottom-0 left-0 backdrop-blur-lg bg-white/90 dark:bg-gray-900/90 duration-500 `}
        >
