        ...
        <section className="py-8">
            <div className="container mx-auto px-2">
                <div className="flex justify-center items-center mb-4 ">
                    <div className='bg-white relative z-10 flex px-3 py-2 rounded-xl gap-1'>
                        <Button
                            size="sm"
                ...
                <div className="flex justify-center items-center relative ">
                    {subscriptions.map((subscription, index) => (
                        <div key={index} dir={`${index == 2 && "ltr"}`} className={`${index == 0 ? "border border-secend relative z-10" : `${index == 2 ? "rotate-[-30deg] -translate-x-10  origin-bottom-left" : "rotate-[30deg] origin-bottom-right"} opacity-30 top-5 sm:flex hidden  absolute -z-0`} xl:w-[25%] lg:w-2/5 w-full sm:w-2/3 md:w-1/2 flex flex-col sm:gap-7 gap-3 px-6 py-10 bg-white rounded-lg shadow-md`}>
                            <div>
                                ...
                                <p className='text-black/70 text-sm'>{subscription.subtitle}</p>
                            </div>
                            <div className='flex gap-4 mt-3  mr-2 '>
                                ...
                                <p className='xxs:text-sm text-xs text-black/70
                            '>
