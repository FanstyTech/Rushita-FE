        ...
        <Card className=" flex-col  border-0 gap-0  shadow-none p-0 ">
            <CardContent className="flex-1 pb-0 px-0 relative">
                ...
                <div className="xsm:block hidden rounded-full absolute lg:-top-8 lg:left-0 left-10 top-12 md:top-5 md:left-5  lg:w-80 lg:h-80 md:w-72 md:h-72 w-60 h-60 border-2 lg:scale-150 scale-125 border-dashed border-black/5">
                    ...
                    <CardDiv bgcolor="bg-[#008EFF]" rotate={45} Icon={Edit2} className="xl:scale-90" title="لديك مراجعة يوم الثلاثاء القادم، نتمنى أن تكون بخير" doctorname="-دكتور وليد" />
                    <CardDiv bgcolor="bg-[#FABB18]" rotate={150} className="top-7 xl:scale-90 " Icon={Flag} title="لديك مراجعة يوم الثلاثاء القادم، نتمنى أن تكون بخير" doctorname="-دكتور وليد" />
                    <CardDiv bgcolor="bg-[#45C646]" rotate={230} className="xl:right-10 md:right-3 right-16 xl:scale-90  " Icon={MessageSquare} title="لديك مراجعة يوم الثلاثاء القادم، نتمنى أن تكون بخير" doctorname="-دكتور وليد" />
