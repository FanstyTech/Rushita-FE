...
const HeroSection = () => {
    ...
    return (
        <Card className="rounded-none p-0 border-0">
            <div className="w-full max-w-7xl  md:py-20 pt-20 border-0  mx-auto min-h-[80vh]  relative  flex items-center justify-center px-4">
                <div className="w-full">
                    <CicyleBg />
                    <CicyleBg className="bottom-20 -left-10" />
                    <div className="text-foreground w-full justify-center items-center flex">
                        <div className="text-center max-w-2xl" dir="rtl">
                            ...
                            <p className="  xxs:text-lg text-base sm:mb-8 mb-3">
