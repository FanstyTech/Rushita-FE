  ...
  translation: {
    ...
    auth: {
      ...
      completeRegistration: {
        title: 'أكمل تسجيلك',
        subtitle: 'أنشئ كلمة مرور آمنة لإكمال إعداد حسابك والانضمام إلى منصة روشيتة الطبية.',
      ...
      registrationSuccess: {
        ...
        subtitle: 'شكراً لك على الانضمام إلى روشيتة. تم تقديم طلبك وهو قيد المراجعة الآن.',
        welcome: 'مرحباً بك في',
        family: 'عائلة روشيتة',
        description: 'تم تقديم تسجيلك بنجاح. سيقوم فريقنا بمراجعة طلبك والرد عليك قريباً.',
        nextSteps: {
          checkEmail: {
