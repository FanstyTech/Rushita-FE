...
import { TestItemDto, TestStatus } from '@/lib/api/types/visit-lab-test';
...
export default function MedicalTestsPage() {
  ...
  // States
  const [selectedTest, setSelectedTest] = useState<TestItemDto | null>(null);
  ...
  const handleViewTestDetails = (test: TestItemDto) => {
    setSelectedTest(test);
    setIsDetailsModalOpen(true);
  };

  const handleUploadTestResults = (test: TestItemDto) => {
    setSelectedTest(test);
    setIsUploadModalOpen(true);
  };

  const handleOpenStatusUpdateModal = (test: TestItemDto) => {
    setSelectedTest(test);
    ...
    <PageLayout>
      <div className="space-y-6">
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <div className="flex-1">
                      <p className="text-xs font-medium text-gray-600 dark:text-gray-300 mb-1">
                        {t('clinic.laboratory.dashboard.totalTests')}
                      </p>
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <div className="flex-1">
                      <p className="text-xs font-medium text-gray-600 dark:text-gray-300 mb-1">
                        {t('clinic.laboratory.dashboard.completed')}
                      </p>
                      <div className="h-0.5 w-full bg-gray-100 dark:bg-gray-700 rounded-full overflow-hidden">
                        <div
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <div className="flex-1">
                      <p className="text-xs font-medium text-gray-600 dark:text-gray-300 mb-1">
                        {t('clinic.laboratory.dashboard.inProgress')}
                      </p>
                      <div className="h-0.5 w-full bg-gray-100 dark:bg-gray-700 rounded-full overflow-hidden">
                        <div
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <div className="flex-1">
                      <p className="text-xs font-medium text-gray-600 dark:text-gray-300 mb-1">
                        {t('clinic.laboratory.dashboard.pending')}
                      </p>
                      <div className="h-0.5 w-full bg-gray-100 dark:bg-gray-700 rounded-full overflow-hidden">
                        <div
        ...
        <FilterBar
          ...
          searchPlaceholder={t('clinic.laboratory.filters.searchPlaceholder')}
          haveStatusFilter={false}
          additionalFilters={[
            {
              icon: <User className="w-4 h-4" />,
              label: t('clinic.laboratory.filters.doctor'),
              options: [
                { value: '', label: t('clinic.laboratory.filters.allDoctors') },
            ...
            },
            {
              ...
              label: t('clinic.laboratory.filters.status'),
        ...
        {/* Content */}
        {visitsWithLabTestsData ? (
          <div className="space-y-6">
            {visitsWithLabTestsData?.length > 0 ? (
              <>
                {visitsWithLabTestsData?.map((visit) => (
                  <Card key={visit.id} className="overflow-hidden">
                      ...
                      <CardHeader className="flex flex-row items-center justify-between p-4 bg-gray-50 dark:bg-gray-800/50 border-b">
                        ...
                        <div className="flex items-center gap-2">
                          <div className="bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 text-xs font-medium px-2.5 py-1 rounded-full">
                            {visit.tests.length}{' '}
                            {visit.tests.length === 1
                              ? t('clinic.laboratory.visit.testsCount')
                              : t('clinic.laboratory.visit.testsCountPlural')}
                          </div>
                          <div
                            className={cn(
                    ...
                    {expandedVisits[visit.id] && (
                      <CardContent className="p-4 space-y-3 border-t border-gray-100 dark:border-gray-700">
                        {visit.tests.map((test: TestItemDto) => (
                          <div
                            key={test.id}
                            ...
                            <div className="flex flex-col md:flex-row justify-between gap-4 pl-2">
                              ...
                              <div className="flex items-center gap-2 self-end md:self-center">
                                ...
                                >
                                  ...
                                  {t('clinic.laboratory.actions.view')}
                                </Button>
                                <Button
                                  variant="outline"
                                  size="sm"
                                ...
                                >
                                  ...
                                  {t('clinic.laboratory.actions.updateStatus')}
                                </Button>
                                {test.status !== TestStatus.Completed &&
                                  test.status !== TestStatus.Cancelled && (
                                    ...
                                    >
                                      ...
                                      {t(
                                        'clinic.laboratory.actions.uploadResults'
                                      )}
                                    </Button>
                                  )}
                              </div>
              ...
              <Card>
                <CardContent className="text-center py-12">
                  ...
                  <CardTitle className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">
                    {t('clinic.laboratory.emptyStates.noVisits')}
                  </CardTitle>
                  <p className="text-sm text-gray-500 dark:text-gray-400 max-w-md mx-auto">
                    {t('clinic.laboratory.emptyStates.noVisitsDescription')}
                  </p>
                </CardContent>
              </Card>
            )}
