...
const mockData = {
  ...
  upcomingAppointments: [
    { id: 1, patient: 'Sarah Johnson', time: '10:30 AM', type: 'Check-up', status: 'confirmed' },
    { id: 2, patient: 'Michael Brown', time: '11:15 AM', type: 'Follow-up', status: 'pending' },
    { id: 3, patient: 'Emily Davis', time: '2:00 PM', type: 'Consultation', status: 'confirmed' },
    { id: 4, patient: 'James Wilson', time: '3:30 PM', type: 'Treatment', status: 'confirmed' }
  ]
};
