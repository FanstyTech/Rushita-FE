...
const mockAppointments = [
  { id: 1, patientName: 'John Doe', time: '09:00 AM', status: 'Scheduled', type: 'Check-up' },
  { id: 2, patientName: 'Jane Smith', time: '10:30 AM', status: 'In Progress', type: 'Follow-up' },
  { id: 3, patientName: 'Mike Johnson', time: '02:00 PM', status: 'Completed', type: 'Consultation' },
  { id: 4, patientName: 'Sarah Wilson', time: '03:30 PM', status: 'Scheduled', type: 'Treatment' },
];
    ...
    <PageLayout >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        >
          ...
          <div className="mt-4 flex items-center text-sm">
            <span className="text-purple-500 font-medium">Next at 10:30 AM</span>
          </div>
        </motion.div>
