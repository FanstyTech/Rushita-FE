          ...
          <div className="max-w-lg">
            ...
            <div className="flex items-center gap-3 mb-8">
              <Image
                ...
                alt={t('auth.registrationSuccess.branding.title')}
                width={40}
                height={40}
            ...
            <div className="mt-8 p-6 bg-white/50 dark:bg-gray-800/50 rounded-2xl backdrop-blur-sm border border-white/20 dark:border-gray-700/50">
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  ...
                  {t('auth.registrationSuccess.contactInfo.emailSupport')}
                </a>
                <a
                ...
                >
                  ...
                  {t('auth.registrationSuccess.contactInfo.whatsapp')}
                </a>
              </div>
            </div>
          </div>
            ...
            <div className="backdrop-blur-xl bg-white/80 dark:bg-gray-800/80 rounded-3xl shadow-2xl border border-white/20 dark:border-gray-700/50 p-8 text-center">
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  {t('auth.registrationSuccess.actions.goToLogin')}
                </Link>
                ...
                >
                  ...
                  {t('auth.registrationSuccess.actions.backToHome')}
                </Link>
              </div>
            </div>
